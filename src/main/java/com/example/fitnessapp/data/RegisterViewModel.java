...
public class RegisterViewModel extends ViewModel {
    ...
    public static int countCalories(String[] foods) {
        int totalCalories = 0;
        int i = 0;
        while (i < foods.length) {
            ...
            if (food.equalsIgnoreCase("apple")) {
                ...
                System.out.println("Unknown food: " + food);
            }
            i++;
        }
    ...
    public static String weightLoss(String[] foods) {
        int calorieCount = countCalories(foods);
        if (calorieCount < 201){
    ...
    public static int calorieLoss (ArrayList<String[]> foods) {
        int total = 0;
        for (String[] food: foods) {
            if ( weightLoss(food).equals("Losing weight"))
                total += countCalories(food);
        }
        return 2000 - total;
    }
